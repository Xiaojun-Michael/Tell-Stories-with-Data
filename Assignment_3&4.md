...
Based on the feedback I got, I think a reader without prior knowledge would be able to understand the general story told by th graph relatively quickly. They will have some questions after loking at the graph, and the answers to the questions are included in the article. So my guess is that after seeing the graph, readers would get the idea and look into the article if that interests them. Also, the two readers have raised some great points, and I plan to make the following additional changes based on the feedback:
...
I picked the side by side circle plot from Tableau, because it is a good way to compare different countries within 3 different categories. The plot type is not much different from the original plot type. Here I am also trying to preserve the light blue and red color setting for The Economist franchise.
...
I picked the side by side circle plot from Tableau, because it is a good way to compare different countries within 3 different categories. The plot type is not much different from the original plot type. Here I am also trying to preserve the light blue and red color setting for The Economist franchise. I am trying to stress on the story of the mismatch here. As a result, I have picked only the adjusted index from the original dataset, the result of the data seems less important in this case. Also, to stress on the comparsion between groups, I have plotted out the average line for each group to highlight the between group comparsion and stress on the point that the data manipulator countries' currency are on average over-valued, just like the normal trading partners'.
